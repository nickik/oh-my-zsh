...
I have my own theme.
There are a couple more functions in there and some aliases and there is a other standard .zshrc
----------------------------------------------
...
@wget http://github.com/nickik/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
** Take a look at the "current themes":http://wiki.github.com/nickik/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
